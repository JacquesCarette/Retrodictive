...
\todo{
code has implementations of ... highlight results; main point here is
equations need not be solved to solve the problem; the question asked
can be answered by looking at the equations !!!!!! and of course can
de-quantize DJ (but measure of complexity is gray not black box)

focus on shor most interesting
optimized shor 15
general shor 15
51, Fermat primes
