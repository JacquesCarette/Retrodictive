...
inputs. These two ideas, while not expressive enough to model arbitrary
...
generating exponentially large equations in some cases and we deal
...
follow Parnas' advice on \emph{faking it}~\cite{parnas1986rational}: a
reconstruction of the requirements as we should have had them if we'd
been all-knowing, and a design that fits those requirements. The
