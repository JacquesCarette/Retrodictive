...
\begin{abstract}
  The classic simulation of quantum programs is a critical endeavor
  ...
  Bernstein-Vaziron, Simon, Grover, and Shor algorithms. The success
...
Thus we never need to residualize a circuit, we can always get a
...
We make some remarks on salient points that arise from doing
symbolic (retrodictive) execution of the algorithms.
