...
for the GHZ circuit on the right, the state after the Hadamard gate is
...
variable. At this point, we can ``partially evaluate'' the circuit
under various regimes. For example, we can set $y_1=0$ and $y_2=1$ and
ask about values of $x_1$ and $x_2$ that would be consistent with this
