...
observations. Firstly, ince quantum algorithms are reversible,
...
The \emph{algebraic normal form}~\cite{TOKAREVA20151} (ANF also called
ring sum normal form, Zhegalkin normal form or Reed-Muller expansion)
of boolean functions $\Bool^n\rightarrow\Bool$ is the exclusive-or of
