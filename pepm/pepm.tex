...
\begin{itemize}
  \item GToffoli and OP for req 4
  \item Circuit for req 5
  \item synthesis for req 6
  \item ArithCirc, QAlgos for req 7
  \item FormAsMap and FormAsBitmap for req 8
\end{itemize}

\subsection{Implementation}

The final code consists of $18$ modules that implement various
services Fig.~\ref{fig:modules}
